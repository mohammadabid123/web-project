...
<?php
	$class = mysqli_query($con, "SELECT * FROM lib_member ORDER BY member_id  ASC");
...
<div class="panel panel-info">
	...
	<div class="panel-heading">
		...
		<h1 align = "center">Library Memeber List</h1>
	</div>
	...
	<div class="panel-body">
		...
		<table class="table table-striped">
			...
			<?php do { ?>
			<tr>
				<td><?php echo $row_class["member_id"]; ?></td>
				<td><?php echo $row_class["student_id"]; ?></td>
				<td><?php echo $row_class["reg_date"]; ?></td>
