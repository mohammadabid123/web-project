...
<?php
	...
	emp_attendance INNER JOIN employee ON employee.employee_id = 
	
	emp_attendance.employee_id WHERE absent_year = $year AND absent_month
	
	= $month GROUP BY emp_attendance.employee_id ORDER BY employee.employee_id 
	ASC");
...
<?php require_once("top.php"); ?>
	...
	<div class="panel panel-primary">
		<div class="panel-heading">
			<a href="employee_attendance_add.php" class="pull-right btn btn-info">
		...
		<div class="panel-body">
			...
			<table class="table table-striped">
				...
				<tr>
					...
					<td>
						<img src="<?php echo $row_attendance["photo"]; ?>" width="40" class="img-circle">
					</td>
					
					<td><?php echo $row_attendance["total"]; ?> hours</td>
					<td>
						<a href="employee_attendance_detail.php?employee_id=<?php echo $row_attendance["employee_id"]; ?>&year=<?php echo $year; ?>&month=<?php echo $month; ?>">
