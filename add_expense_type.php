...
<?php
	...
	if(isset($_POST["type_name"])) {
		...
		$result = mysqli_query($con, "INSERT INTO expense_type VALUES (NULL, '$type_name')");
		
		if($result) {
			
			header("location:expense_list.php?add=INSERTED");
		}
		else {
			header("location:add_expense_type.php?error=" . mysqli_error($con));
		}
